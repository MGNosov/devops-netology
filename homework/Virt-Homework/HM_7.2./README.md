# Домашнее задание к занятию "7.2. Облачные провайдеры и синтаксис Terraform." Носов Максим
...
###### Ответ: [конфигурационные файлы Terraform](https://github.com/MGNosov/devops-netology/tree/main/homework/Virt-Homework/HM_7.2./terraform-cloud)
При выполнении даной работы использовал домашнюю работу 5.5. добавив файлы с конфигурацией сети в YC и variables.tf. 
Вывод команд terraform validate и terraform plan
````
mgnosov@Maksims-MacBook-Pro terraform-cloud % terraform validate
Success! The configuration is valid.

mgnosov@Maksims-MacBook-Pro terraform-cloud % terraform plan    
